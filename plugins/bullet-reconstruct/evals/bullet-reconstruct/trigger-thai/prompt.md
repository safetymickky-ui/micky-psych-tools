---
description: "Trigger positive with the Thai phrasings from the description ('ทำเป็น bullet', 'ย่อเป็นข้อ ๆ'). Same passage as trigger-article. Read-only tools. Graders: the skill fired; a number survived."
tags: [bullet-reconstruct, trigger]
allowed_tools: [Read, Glob, Grep, Skill]
max_turns: 15
---

ช่วยทำเป็น bullet ให้หน่อย ย่อเป็นข้อ ๆ ตัด reference ออก:
