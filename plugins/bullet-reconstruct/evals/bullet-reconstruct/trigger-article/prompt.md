---
description: "Trigger positive in the owner's own phrasing ('reconstruct this article'). A dense passage with citation markers and an inline reference list. Read-only tools, so the bullets come back in the reply. Graders: the skill fired; a number survived; the citation markers are gone."
tags: [bullet-reconstruct, trigger, smoke]
allowed_tools: [Read, Glob, Grep, Skill]
max_turns: 15
---

Reconstruct this article in bullets and drop the references, keep it tight:
