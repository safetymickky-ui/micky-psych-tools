...
# Planted: firecrawl plugin.json 0.2.0 vs catalog 0.1.0; its description has no Not-for clause.
set -euo pipefail
...
cat > .claude-plugin/marketplace.json <<'EOF'
{
  ...
  "plugins": [
    ...
    {"name": "firecrawl", "source": "./plugins/firecrawl", "version": "0.1.0", "description": "Fixture plugin.", "category": "productivity", "keywords": ["firecrawl", "web-scraping", "crawl"]}
  ]
}
EOF
